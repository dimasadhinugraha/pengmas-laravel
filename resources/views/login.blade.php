        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="btn btn-primary rounded-pill px-4 w-100" href="{{ route('register') }}">Register</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="login-card p-4 p-md-5">
                        ...
                        <div class="alert alert-success alert-dismissible fade show mb-4" role="alert">
                            ...
                            Registrasi berhasil! Silakan tunggu SMS dari admin untuk mengaktifkan akun Anda.
                        ...
                        <form action="{{ route('login.success') }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="nik" class="form-control border-start-0" id="NIK"
                            ...
                            <div class="mb-4 d-flex justify-content-between align-items-center">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" name="remembe,.mnr" id="remember">
